...
from cs336_basics.BPETokenizer.TokenizerAdapter import Tokenizer
...
def run_linear(
    ...
    model: torch.nn.Module = TransformerModules.Linear(d_in, d_out)
...
def run_embedding(
    ...
    # raise NotImplementedError
    model = TransformerModules.Embedding(vocab_size, d_model)
    state = model.state_dict()
    state["embed_map"] = weights
    model.load_state_dict(state)
...
def run_rope(
    ...
    """
    # raise NotImplementedError
    model = TransformerModules.RoPE(theta, d_k, max_seq_len)
...
def run_rmsnorm(
    ...
    """
    # raise NotImplementedError
    model = TransformerModules.RMSNorm(d_model, eps)
    state = model.state_dict()
    state["weights"] = weights
    model.load_state_dict(state)
    return model(in_features)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    # raise NotImplementedError
    return TransformerModules.softmax(in_features, dim)
...
def run_cross_entropy(
    ...
    """
    # raise NotImplementedError
    return TransformerModules.cross_entropy(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    # raise NotImplementedError
    return TransformerModules.clip_gradient(parameters, max_l2_norm)
...
def get_adamw_cls() -> Any:
    ...
    """
    # raise NotImplementedError
    return TransformerModules.AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    # raise NotImplementedError
    return TransformerModules.lr_cos_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_train_bpe(
    ...
    **kwargs,
    ...
    """
    # raise NotImplementedError
    tokenizer = BPEtokenizer(vocab_size=vocab_size, special_words=special_tokens)
    tokenizer.train(input_path)
    return tokenizer.vocab_map, [x for x in tokenizer.merge_ranks.keys()]
